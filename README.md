...
git clone -b main https://github.com/SilkKirk/OpenList-1Panel.git "$install_dir/1panel/resource/apps/local/OpenList"

if [ $? -eq 0 ]; then
    rm -rf $install_dir/1panel/resource/apps/local/openlist
    mv $install_dir/1panel/resource/apps/local/OpenList $install_dir/1panel/resource/apps/local/openlist
    echo "success"
else
    echo "error"
    exit 1
